...
@section('title','Ibarra Market Online  | Resultados de la busqueda')
@section('body-class', 'profile-page sidebar-collapse')

@section('content')
  <!--jumbotron-->
  <div class="page-header header-filter" data-parallax="true" style="background-image: url({{ asset('img/tienda.jpg') }})">
  </div>
  <!-- end jumbotron-->
